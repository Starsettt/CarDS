...
public class Queries extends ConnectionDB
{
    ...
    public void ExQueryForCars(String query) throws SQLException
    {
        ResultSet resultSet = statement.executeQuery(query);
        while (resultSet.next())
        {
            int id = resultSet.getInt("id");
            String mark = resultSet.getString("title");
    ...
    public void UpQueryForInsurance(String query) throws SQLException
    {
        statement.executeUpdate(query);
    }
}
